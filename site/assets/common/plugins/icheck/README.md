...
* **Identical inputs across different browsers and devices** â€” both [desktop and mobile](#browser-support)
* **Touch devices support** â€” iOS, Android, BlackBerry, Windows Phone, Amazon Kindle
* **Keyboard accessible inputs** â€” `Tab`, `Spacebar`, `Arrow up/down` and other shortcuts
* **Customization freedom** â€” use any HTML and CSS to style inputs (try [6 Retina-ready skins](http://fronteed.com/iCheck/))
