...
summernote.js - Renderer.js (Generate markup) - Locale.js (Locale object)
              ã„´EventHandler.js - Editor.js  (Abstract editor)
                                ã„´Style.js   (Style Getter and Setter)
                                ã„´History.js (Store on jQuery.data)
                                ã„´Toolbar.js (Toolbar module)
                                ã„´Popover.js (Popover module)
                                ã„´Handle.js  (Handle module)
                                ã„´Dialog.js  (Dialog module)
-----------------------------Core Script-----------------------------
