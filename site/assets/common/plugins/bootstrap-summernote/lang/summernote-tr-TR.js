(function ($) {
  $.extend($.summernote.lang, {
    'tr-TR': {
      ...
      lists: {
        unordered: 'Madde iÅŸaretli liste',
      ...
      color: {
        ...
        setTransparent: 'ÅžeffaflÄ±ÄŸÄ± ayarla',
        reset: 'SÄ±fÄ±rla',
