...
var Categorias = function() {
	...
	var handleTable = function(){
		...
		var table = $("#tblProductos").DataTable({
			...
			ajax: {
				url: __SITEURL+'admin/categorias/datasource',
				type: 'POST'
			},
	...
	var handleDelete = function(){
		$('#tblProductos').on('click','a.btn-eliminar', function(e){
			...
			WebDialogs.doConfirm({
				message: 'Esta a punto de eliminar La Categoria <strong>'+usuarioNombre+'</strong>. Si esta seguro que desea eliminar el Producto haga click en aceptar, de lo contrario cancele la opción.',
			...
			WebDialogs.doConfirm({
				...
				onConfirm: function(){
					...
					$.ajax({
						...
						success: function (jsonData){
							if (jsonData.status == true){
								window.location.href = __SITEURL + 'admin/categorias';
							} else {
								alert(jsonData.message);
							}
						}
	...
	var handleEliminarTodos = function(){
		$('#eliminar_todos').on('click', function(e){
			...
			$.ajax({
				url: __SITEURL+'admin/categorias/eliminar_todos/',
				data: {
					lote:lote
				},
				type: 'POST',
	...
	var handleMarcasSelect = function(){
		...
		$('.marca').change(function(){
			...
			$.ajax({
				type: 'post',
				url: __SITEURL+"admin/categorias/submarcas_x_marcas",
				data:{
					marcaId : marcaId
				},
				dataType: 'json',
	...
	var handleImprimirPrecios = function(){
		...
		$('.bt_imprimir').on('click', function(e){
			...
			window.location.href = __SITEURL+'admin/categorias/imprimir/'+$('#filtro-marca').val();
