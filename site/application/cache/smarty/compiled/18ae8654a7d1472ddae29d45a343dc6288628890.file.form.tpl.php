<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-05 17:35:10
         compiled from "C:\wamp\www\daps\diegodaps\site\application\views\admin\clientes\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154095bb784ae7548e3-66718587%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18ae8654a7d1472ddae29d45a343dc6288628890' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\clientes\\form.tpl',
      1 => 1538514863,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '154095bb784ae7548e3-66718587',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bb784aec09059_60573685',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bb784aec09059_60573685')) {function content_5bb784aec09059_60573685($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/clientes/save" id="frmSaveClientes" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
                                                    <label class="control-label">Fecha de Nacimiento</label>
                                                        <div class="input-group date date-picker" data-date-format="dd/mm/yyyy">
                                                            <input type="text" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" value="<?php if ($_smarty_tpl->tpl_vars['editUser']->value->fecha_nacimiento) {
echo $_smarty_tpl->tpl_vars['editUser']->value->fecha_nacimiento->format('d/m/Y');
}?>">
                                                ...
                                                <div class="form-group">
													<label class="control-label">Teléfono</label>
														<input type="text" class="form-control" name="telefono" placeholder="Teléfono" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->telefono;?>
">
												</div>
												<!--      Imagen      -->
												<div class="form-group">
						                            <label class="control-label">Foto</label>
						                                <div class="checkbox-list">
						                                    ...
						                                    <?php if ($_smarty_tpl->tpl_vars['editUser']->value->foto) {?>
						                                    <img name="imageThumb" id="imageThumb" src="<?php echo \Managers\ImagenManager::getInstance()->getUrl($_smarty_tpl->tpl_vars['editUser']->value->foto,'');?>
" class="img-responsive">
						                                    <label><input name="borrar_imagen" type="checkbox" value="1" >Borrar Foto </label>
						                                    <?php } else { ?>
						                                    <img name="imageThumb" id="imageThumb" src="<?php echo site_url();?>
uploads/sin-imagen120.jpg" class="img-responsive">
						                                    <?php }?>
						                                </div>
						                        </div>
						                        ...
						                        <div class="form-group">
													<label class=" control-label">Puntos Acumulados</label>
														<input type="text" class="form-control" name="puntos_acumulados" placeholder="Puntos Acumulados" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->puntos_acumulados;?>
" >
												</div>
												...
												<div class="form-group">
													<label class="control-label">Correo electrónico</label>
														<div class="input-group">
															...
															<input type="email" class="form-control required email" placeholder="Correo electrónico" name="email" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->email;?>
">
														</div>
												</div>
						                        ...
						                        <div class="form-group">
						                            ...
						                            <div class="col-md-9">
														<div class="checkbox-list">
						                                	<label><input name="bloqueado" type="checkbox" value="1" <?php if ($_smarty_tpl->tpl_vars['editUser']->value->bloqueado==true) {?>checked="checked"<?php }?> /></label>
														</div>
						                            </div>						                            
						                        </div>

						                        <div class="form-group panel_bloqueo <?php if ($_smarty_tpl->tpl_vars['editUser']->value->bloqueado==false) {?>hidden<?php }?>">
						                        	<div class="col-md-9">
	                                                    <label class="control-label">Fecha de DesBloqueo</label>
                                                        <div class="input-group date date-picker" data-date-format="dd/mm/yyyy">
                                                            <input type="text" class="form-control" name="fecha_desbloqueo" id="fecha_desbloqueo" value="<?php if ($_smarty_tpl->tpl_vars['editUser']->value->fecha_desbloqueo) {
echo $_smarty_tpl->tpl_vars['editUser']->value->fecha_desbloqueo->format('d/m/Y');
} else {
echo $_smarty_tpl->tpl_vars['fecha_desbloqueo']->value->format('d/m/Y');
}?>">
                                                            <span class="input-group-btn">
                                                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                            </span>
...
admin/clientes" class="btn btn-link btn-lg pull-right">Cancelar</a>
											</div>
										</form>
										<!-- END FORM-->
									</div>
