                                ...
                                <div class="form-group">
                                    <label class="control-label m-b-1 ">Servicio</label>
                                        ...
                                        <select id="filtro-servicio" name="filtro-servicio" class="form-control select2 " placeholder='Seleccione Servicio'>
                                            <option value="">Sin filtrar</option>
                                        <?php  $_smarty_tpl->tpl_vars['aSe'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['aSe']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['servicios']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['aSe']->key => $_smarty_tpl->tpl_vars['aSe']->value) {
$_smarty_tpl->tpl_vars['aSe']->_loop = true;
?>
                                            <option value="<?php echo $_smarty_tpl->tpl_vars['aSe']->value->id;?>
"><?php echo $_smarty_tpl->tpl_vars['aSe']->value->nombre;?>
</option>
                                        <?php } ?>
                                        </select>
                                </div>
