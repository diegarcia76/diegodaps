<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-24 18:54:07
         compiled from "C:\wamp\www\daps\diegodaps\site\application\views\admin\servicios\precios.tpl" */ ?>
<?php /*%%SmartyHeaderCode:275945bd0e9a7c0be15-81472814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1d887c172ba4f0955e1337e200bb524d2cf20b6' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\servicios\\precios.tpl',
      1 => 1540418041,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '275945bd0e9a7c0be15-81472814',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5bd0e9a858cc59_35854455',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5bd0e9a858cc59_35854455')) {function content_5bd0e9a858cc59_35854455($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
<div class="page-container">
    ...
    <div class="portlet-title">
       <div class="table-toolbar">
	        <div class="row">
                <div class="col-md-6">
                    <a class="bt_imprimir btn default green" href="<?php echo site_url();?>
admin/servicios/imprimir"><i class="fa fa-print"></i> IMPRIMIR</a>
                </div>
                <div class="col-md-6 text-right">
                        <a class="btn default" href="<?php echo site_url();?>
admin/servicios">Volver a Servicios</a>
                </div>                
	        </div>
	    </div>
    </div>
...
<div class="panel-body tabla-responsive">
 <table class="table table-stripped table-responsive" id="tblPrecioServicios">
    ...
    <tbody>
        <?php  $_smarty_tpl->tpl_vars['aServicio'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['aServicio']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aServicios']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['aServicio']->key => $_smarty_tpl->tpl_vars['aServicio']->value) {
$_smarty_tpl->tpl_vars['aServicio']->_loop = true;
?>
            
            <tr>
                <form class="form frmCambiarPrecioServicio" action="<?php echo site_url();?>
admin/servicios/cambiarPrecio">
                    <td><?php echo $_smarty_tpl->tpl_vars['aServicio']->value->id;?>

                        <input type="hidden" name="servicio_id" value="<?php echo $_smarty_tpl->tpl_vars['aServicio']->value->id;?>
">
                    </td>
                    <td><?php echo $_smarty_tpl->tpl_vars['aServicio']->value->nombre;?>
</td>
					 <td><input type="text" class="number form-control" name="servicio_precio_efectivo_default" value="<?php echo number_format($_smarty_tpl->tpl_vars['aServicio']->value->precio_efectivo_default,2,'.',',');?>
" data-default="<?php echo number_format($_smarty_tpl->tpl_vars['aServicio']->value->precio_efectivo_default,2,'.',',');?>
"></td>
                    <td><input type="text" class="number form-control" name="servicio_precio_default" value="<?php echo number_format($_smarty_tpl->tpl_vars['aServicio']->value->precio_default,2,'.',',');?>
" data-default="<?php echo number_format($_smarty_tpl->tpl_vars['aServicio']->value->precio_default,2,'.',',');?>
"></td>
                 
                    <td><button class="btn blue" type="submit">Guardar</button></td>
					 <td><input type="checkbox" name="eliminar[]" class="eliminar" id="eliminar" rel="<?php echo $_smarty_tpl->tpl_vars['aServicio']->value->id;?>
" value="<?php echo $_smarty_tpl->tpl_vars['aServicio']->value->id;?>
"/></td>
                </form>
            </tr>
