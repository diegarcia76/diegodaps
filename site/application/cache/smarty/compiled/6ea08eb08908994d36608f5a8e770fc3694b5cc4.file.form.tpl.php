<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-11-20 17:18:09
         compiled from "C:\wamp\www\daps\diegodaps\site\application\views\admin\servicios\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:282965beb2afb84c037-75293091%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ea08eb08908994d36608f5a8e770fc3694b5cc4' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\servicios\\form.tpl',
      1 => 1542745084,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '282965beb2afb84c037-75293091',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5beb2afbb3cb71_27792458',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5beb2afbb3cb71_27792458')) {function content_5beb2afbb3cb71_27792458($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/servicios/save" id="frmSaveServicios" method="post">
...
"   <?php if ($_smarty_tpl->tpl_vars['editUser']->value->categoria==$_smarty_tpl->tpl_vars['c']->value->id) {?> selected="selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['c']->value->nombre;?>
</option>
									<?php } ?>
												...
												<div class="form-group">
													<label class="control-label">Precio Puntos</label>
														<input type="text" class="form-control" name="precio_puntos" placeholder="Precio Puntos" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->precio_puntos;?>
" >
												</div>

						                        <div class="form-group">
													<label class="control-label">Puntos Premio</label>
														<input type="text" class="form-control" name="puntos_premio" placeholder="Puntos Premio" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->puntos_premio;?>
" >
												</div>

												<div class="form-group">
													<label class="control-label">Duración Incial</label>
														<input type="text" class="form-control" name="duracion" placeholder="Duración Inicial" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->duracion;?>
" >
												</div>

						                        <div class="form-group">
													<label class="control-label">Duración espera (Intervalo)</label>
														<input type="text" class="form-control" name="duracion_espera" placeholder="Duración espera" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->duracion_espera;?>
" >
												</div>
												
												<div class="form-group">
													<label class="control-label">Duración Final</label>
														<input type="text" class="form-control" name="intervalo" placeholder="Duración Final" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->intervalo;?>
" >
												</div>
												...
												<div class="form-group">
					                                ...
					                                <div class="input-group">
					                                    ...
					                                    <input type="text" class="form-control" name="precio_default" placeholder="Precio Default" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->precio_default;?>
">
					                                </div>                            
					                            </div>
												...
												<div class="form-group">
					                                ...
					                                <div class="input-group">
					                                    <span class="input-group-addon" id="basic-addon1">$</span>
					                                    <input type="text" class="form-control" name="precio_efectivo_default" placeholder="Precio Efectivo Default" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->precio_efectivo_default;?>
">
					                                </div>                            
					                            </div>
												...
												<div class="form-group">
					                                ...
					                                <div class="input-group">
					                                    <span class="input-group-addon" id="basic-addon1">%</span>
					                                    <input type="text" class="form-control" name="comision_default" placeholder="Comisión Default" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->comision_default;?>
">
					                                </div>                            
					                            </div>
					                            ...
					                            <div class="form-group">
													<label class="control-label">División Grilla (en minutos)</label>
														<input type="text" class="form-control" name="division_grilla" placeholder="División Grilla" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->division_grilla;?>
" >
												</div>
					                            ...
					                            <div class="form-group">
						                            <label class="control-label">En App</label>
														<div class="checkbox-list">
						                                	<label><input name="servicioEnApp" type="checkbox" value="1" <?php if ($_smarty_tpl->tpl_vars['editUser']->value->servicioEnApp==true) {?>checked="checked"<?php }?> /></label>
														</div>
						                        </div>
...
admin/servicios" class="btn default pull-right">Cancelar</a>
												</div>
											</div>
										</form>
										<!-- END FORM-->
