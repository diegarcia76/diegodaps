...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '247485bcf903c79a494-85972621',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5bcf903d00d316_75502105',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5bcf903d00d316_75502105')) {function content_5bcf903d00d316_75502105($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/balance/saveChange" id="" method="post" >
										<input type="hidden" name="pago" value="<?php echo $_smarty_tpl->tpl_vars['pago']->value->id;?>
" />
                                        <div class="caption">
											<i class="fa fa-pencil font-green-sharp"></i>
                                            <span class="caption-subject font-green-sharp bold uppercase">Pago asignado a: <?php echo $_smarty_tpl->tpl_vars['pago']->value->coiffeur->nombre;?>
 </span>
										</div>	
											<div class="form-body">
...
?>
							<?php if ($_smarty_tpl->tpl_vars['aCoiffeur']->value->id!=$_smarty_tpl->tpl_vars['pago']->value->coiffeur->id) {?>
...
admin/balance" class="btn btn-link btn-lg pull-right">Cancelar</a>
											</div>
										</form>
										<!-- END FORM-->
									</div>
