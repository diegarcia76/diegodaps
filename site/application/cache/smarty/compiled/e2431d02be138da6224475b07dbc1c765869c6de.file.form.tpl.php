...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '238745bf45f4df334f5-26948112',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5bf45f4e20af64_09076894',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5bf45f4e20af64_09076894')) {function content_5bf45f4e20af64_09076894($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/categorias/save" id="frmSaveProductos" method="post">
						...
						<div class="form-group">
							<label class="control-label">Color</label>
								<select id="color" name="color" class="form-control select2 " placeholder='Seleccione Color'>
                                    <option value="verde"   <?php if ($_smarty_tpl->tpl_vars['editUser']->value->nombre=='verde') {?> selected="selected" <?php }?> >Verde</option>
									<option value="azul" <?php if ($_smarty_tpl->tpl_vars['editUser']->value->nombre=='azul') {?> selected="selected" <?php }?>>Azul</option>
									<option value="rojo" <?php if ($_smarty_tpl->tpl_vars['editUser']->value->nombre=='rojo') {?> selected="selected" <?php }?>>Rojo</option>
...
admin/categorias" class="btn default pull-right">Cancelar</a>
						</div>
					</div>
				</form>
				<!-- END FORM-->
