<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-26 15:16:28
         compiled from "/var/www/daps/site/application/views/admin/usuarios/ver.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6502048015a944ab9a56c10-30811245%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7f6ba7b1f3f8dec8dbcc203310f9ee52c643b572' => 
    array (
      0 => '/var/www/daps/site/application/views/admin/usuarios/ver.tpl',
      1 => 1519668951,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '6502048015a944ab9a56c10-30811245',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a944ab9ace2a5_78935975',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5a944ab9ace2a5_78935975')) {function content_5a944ab9ace2a5_78935975($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
<div class="page-container">
    ...
    <table class="table table-striped">
    	<tr><th><h2>Código</h2></th><td><h2><strong><?php echo $_smarty_tpl->tpl_vars['usuario']->value->id;?>
</strong></h2></td></tr>
        <tr><th>Nombre</th><td><?php echo $_smarty_tpl->tpl_vars['usuario']->value->nombre;?>
</td></tr>
        <tr><th>E-mail</th><td><?php echo $_smarty_tpl->tpl_vars['usuario']->value->email;?>
</td></tr>
        <tr><th>Perfil</th><td><?php echo $_smarty_tpl->tpl_vars['usuario']->value->perfil->nombre;?>
</td></tr>
       	<tr><th>Fecha Alta</th><td><?php if ($_smarty_tpl->tpl_vars['usuario']->value->fecha_alta) {
echo $_smarty_tpl->tpl_vars['usuario']->value->fecha_alta->format('d/m/Y H:i:s');
}?></td></tr>
        <tr><th>Activo</th><td><?php if ($_smarty_tpl->tpl_vars['usuario']->value->activo==true) {?>Si<?php } else { ?>No<?php }?></td></tr>
        </table>
    <hr />
    <div class="text-right">
    	<a href="<?php echo site_url();?>
admin/usuarios/editar/<?php echo $_smarty_tpl->tpl_vars['usuario']->value->id;?>
" class="btn yellow"><i class="fa fa-pencil"></i> Editor</a>
    	<a href="<?php echo site_url();?>
admin/usuarios/eliminar/<?php echo $_smarty_tpl->tpl_vars['usuario']->value->id;?>
" class="btn red btn-eliminar-usuario" title="<?php echo $_smarty_tpl->tpl_vars['usuario']->value->nombre;?>
...
>
    ...
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/backend/plugins/datatables/media/js/jquery.dataTables.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/backend/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/backend/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/backend/plugins/datatables/extensions/Scroller/js/dataTables.scroller.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/backend/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js"><?php echo '</script'; ?>
>
