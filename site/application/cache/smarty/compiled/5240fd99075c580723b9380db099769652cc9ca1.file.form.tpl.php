<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-24 15:43:46
         compiled from "C:\wamp\www\daps\diegodaps\site\application\views\admin\tarjetas\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53825bd0bcf11652b4-45396686%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5240fd99075c580723b9380db099769652cc9ca1' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\tarjetas\\form.tpl',
      1 => 1540406621,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '53825bd0bcf11652b4-45396686',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5bd0bcf1382d83_28422354',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5bd0bcf1382d83_28422354')) {function content_5bd0bcf1382d83_28422354($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/tarjetas/save" id="" method="post">
                                        	
											<div class="form-body">

												<div class="form-group">
													<label class="control-label">1 Cuota</label>
														<input type="text" class="form-control" name="c1" value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota1;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">2 Cuotas</label>
														<input type="text" class="form-control" name="c2"  value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota2;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">3 Cuotas</label>
														<input type="text" class="form-control" name="c3" value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota3;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">4 Cuotas</label>
														<input type="text" class="form-control" name="c4"  value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota4;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">5 Cuotas</label>
														<input type="text" class="form-control" name="c5" value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota5;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">6 Cuotas</label>
														<input type="text" class="form-control" name="c6"  value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota6;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">7 Cuotas</label>
														<input type="text" class="form-control" name="c7" value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota7;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">8 Cuotas</label>
														<input type="text" class="form-control" name="c8"  value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota8;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">9 Cuotas</label>
														<input type="text" class="form-control" name="c9" value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota9;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">10 Cuotas</label>
														<input type="text" class="form-control" name="c10"  value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota10;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">11 Cuotas</label>
														<input type="text" class="form-control" name="c11" value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota11;?>
" required="required">
												</div>
												
												<div class="form-group">
													<label class="control-label">12 Cuotas</label>
														<input type="text" class="form-control" name="c12"  value="<?php echo $_smarty_tpl->tpl_vars['aTarjetas']->value->cuota12;?>
" required="required">
												</div>
