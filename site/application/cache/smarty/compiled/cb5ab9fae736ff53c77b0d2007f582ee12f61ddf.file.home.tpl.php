<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-06-25 14:13:22
         compiled from "/var/www/daps/site/application/views/home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2998058195819fcfa0d0758-10169212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb5ab9fae736ff53c77b0d2007f582ee12f61ddf' => 
    array (
      0 => '/var/www/daps/site/application/views/home.tpl',
      1 => 1529946798,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2998058195819fcfa0d0758-10169212',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5819fcfa149df7_49045337',
  'variables' => 
  array (
    'page_nocache' => 0,
    'usuarioActual' => 0,
...
<?php if ($_valid && !is_callable('content_5819fcfa149df7_49045337')) {function content_5819fcfa149df7_49045337($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/daps/site/application/third_party/Smarty/plugins/modifier.date_format.php';
?><!doctype html>
...
turnos/nuevo_turno" class="btn btn-link pull-right">NUEVO TURNO</a>
                    ...
                    <div class="panel panel-default">
                        <div class="turnos table">
                            <?php if ($_smarty_tpl->tpl_vars['turnosProximos']->value) {?>
                                <?php  $_smarty_tpl->tpl_vars['turno'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['turno']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['turnosProximos']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars['turno']->_loop = true;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['foo']['first'] = $_smarty_tpl->tpl_vars['turno']->first;
?>


                                <div class="tr <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['foo']['first']) {?> first <?php }?>">
                                    <div class="td text-primary turno">
                                        <span class="big"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['turno']->value->fecha_hora,"%e");?>
</span>
                                        <span class="day"><?php echo mb_strtoupper(smarty_modifier_date_format($_smarty_tpl->tpl_vars['turno']->value->fecha_hora,"%A"), 'UTF-8');?>
</span>
                                        <span class="month"><?php echo mb_strtolower(smarty_modifier_date_format($_smarty_tpl->tpl_vars['turno']->value->fecha_hora,"%B"), 'UTF-8');?>
</span>
                                    </div>
                                    <div class="td text-warning hour"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['turno']->value->fecha_hora,"%k:%M");?>
 hs</div>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['turno']->value->prioridad!=0) {?>
                                        <div class="td state"><span class="label label-danger">lista de espera</span></div>
                                    <?php }?>
                                    <div class="td icon edit"><a href="<?php echo site_url();?>
turnos/editar_turno/<?php echo $_smarty_tpl->tpl_vars['turno']->value->id;?>
"><i class="fa fa-pencil" aria-hidden="true"></i></a></div>
                                    <div class="td icon"><a href="<?php echo site_url();?>
turnos/eliminar/<?php echo $_smarty_tpl->tpl_vars['turno']->value->id;?>
" data-turnoId="<?php echo $_smarty_tpl->tpl_vars['turno']->value->id;?>
" class="btn-eliminar"><i class="fa fa-trash-o" aria-hidden="true"></i></a></div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 row-title">
                            ...
                            <a href="<?php echo site_url();?>
profile/historial" class="btn btn-link pull-right">VER TODO</a>
                        </div>
                    </div>
...
?>
                                <div class="tr <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['faa']['first']) {?> first <?php }?>">
...
" alt="..." class="img-responsive pull-left">
                                            <?php } ?>
                                            <!--a href="historia.php">
...
>
    ...
    <?php echo '<script'; ?>
 src="<?php echo site_url();?>
assets/js/turnos.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo site_url();?>
