<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-25 12:26:20
         compiled from "C:\wamp\www\daps\diegodaps\site\application\views\admin\coiffeurs\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:111755bd1e09c37bf30-93565688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8bd50bdd8d22e21c20f904dfb568238a081f6d9f' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\coiffeurs\\form.tpl',
      1 => 1538514863,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '111755bd1e09c37bf30-93565688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bd1e09c9dd430_71536718',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bd1e09c9dd430_71536718')) {function content_5bd1e09c9dd430_71536718($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/coiffeurs/save" id="frmSaveCoiffeurs" method="post">
...
uploads/sin-imagen120.jpg" class="img-responsive">
						                        ...
						                        <?php if (!$_smarty_tpl->tpl_vars['editUser']->value) {?>
							                        <div class="form-group">
														...
														<div class="checkbox-list">
															<?php  $_smarty_tpl->tpl_vars['aServ'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['aServ']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['servicios']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['aServ']->key => $_smarty_tpl->tpl_vars['aServ']->value) {
$_smarty_tpl->tpl_vars['aServ']->_loop = true;
?>
						                                		<label><input name="servicios[]" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['aServ']->value->id;?>
" /><?php echo $_smarty_tpl->tpl_vars['aServ']->value->nombre;?>
</label>
															<?php } ?>
														</div>
							                        </div>
...
admin/coiffeurs" class="btn default pull-right">Cancelar</a>
												</div>
											</div>
										</form>
										<!-- END FORM-->
