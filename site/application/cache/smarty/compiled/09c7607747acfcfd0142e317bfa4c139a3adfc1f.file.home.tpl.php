<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-12-03 16:36:41
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    'fae468556d9591ed5d650206b22c7e768ef82a31' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\deudores\\modal-agregar-producto.tpl',
      1 => 1541441035,
      2 => 'file',
    ),
    'eb09c57df9d8d18f1fa59beb6007127a463c5166' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\deudores\\modal-agregar-servicio.tpl',
      1 => 1541441041,
      2 => 'file',
    ),
    'cabfe3fd510a427705676878e3f93adde5f79764' => 
    array (
      0 => 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\views\\admin\\deudores\\modal-agregar-item.tpl',
      1 => 1541441024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174595be0869669db89-57356234',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5be086972dac62_45511368',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5be086972dac62_45511368')) {function content_5be086972dac62_45511368($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\daps\\diegodaps\\site\\application\\third_party\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<!--
...
"><i class="fa fa-chevron-down"></i></button>
												...
												<input type="checkbox" name="eliminarPago[]" class="eliminarPago" id="eliminarPago" rel="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
" value="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
"/>		
...
" > <i class="fa fa-pencil"></i></button>
																				...
																				<input type="checkbox" name="eliminar[]" class="eliminar_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
" id="eliminar_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
" rel="<?php echo $_smarty_tpl->tpl_vars['aDetallePago']->value->id;?>
...
<div id="confirmarCobro_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
...
">Cobrar este monto en $</button>
						<button class="btn btn-success green btn-confirm-no-descuento-t" id="btn-confirm-no-descuento-t" data-id-pago="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
">Cobrar este monto c/ Tarjeta</button>
		            </p>
		            ...
		            <p class="wpr-fecha-cobro form-inline hidden">
		            	Fecha de Cobro:<br/>
			            <input type="text" class="form-control fecha_cobro" id="fecha_cobro_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
" name="fecha_cobro_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
">
					...
					<p class="wpr-tarjeta-cobro form-inline ">
			            ...
			            <select id="t_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
"  name="t" class="form-control select2 t" placeholder='tarjeta' data-id-pago="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
">
...
"><?php echo $_smarty_tpl->tpl_vars['t']->value->cuota12;?>
 ...
 c/u</option>
            ...
            <div class="modal-footer">
              	...
              	<button class="btn btn-success green btn-confirm-efectivo" data-id-pago="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
"></button>
              	<button class="btn btn-success green btn-confirm-no-efectivo" data-id-pago="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
"></button>
				<button class="btn btn-success blue cobrarCombinando" data-id-pago="<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
">Combinar</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div id="confirmarCobroCombinado_<?php echo $_smarty_tpl->tpl_vars['aPago']->value->id;?>
" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
...
content_5c0585ca2c5be0_12709497($_smarty_tpl);
...
content_5c0585ca3d7286_40858198($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_5c0585ca490d62_75601294($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/admin/js/deudores.js?version=20180712"><?php echo '</script'; ?>
>
...
<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-12-03 16:36:42
         compiled from "C:\wamp\www\daps\diegodaps\site\application\views\admin\deudores\modal-agregar-producto.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5c0585ca2c5be0_12709497')) {function content_5c0585ca2c5be0_12709497($_smarty_tpl) {?><div id="modal-agregar-producto" class="modal" tabindex="-1" role="dialog" aria-labelledby="modal-agregar-producto-label" aria-hidden="true" data-backdrop='static'>
...
<?php if ($_valid && !is_callable('content_5c0585ca3d7286_40858198')) {function content_5c0585ca3d7286_40858198($_smarty_tpl) {?><div id="modal-agregar-servicio" class="modal" tabindex="-1" role="dialog" aria-labelledby="modal-agregar-servicio-label" aria-hidden="true" data-backdrop='static'>
...
<?php if ($_valid && !is_callable('content_5c0585ca490d62_75601294')) {function content_5c0585ca490d62_75601294($_smarty_tpl) {?><div id="modal-agregar-item" class="modal" tabindex="-1" role="dialog" aria-labelledby="modal-agregar-item-label" aria-hidden="true" data-backdrop='static'>
