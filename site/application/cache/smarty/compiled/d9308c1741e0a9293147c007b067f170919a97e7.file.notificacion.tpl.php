<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-03-02 14:00:57
         compiled from "/var/www/daps/site/application/views/notificacion.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8523556165845c87d17e754-00482401%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd9308c1741e0a9293147c007b067f170919a97e7' => 
    array (
      0 => '/var/www/daps/site/application/views/notificacion.tpl',
      1 => 1484329123,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8523556165845c87d17e754-00482401',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5845c87d24c678_79482768',
  'variables' => 
  array (
    'page_nocache' => 0,
    'usuarioActual' => 0,
...
<?php if ($_valid && !is_callable('content_5845c87d24c678_79482768')) {function content_5845c87d24c678_79482768($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/daps/site/application/third_party/Smarty/plugins/modifier.date_format.php';
...
<div id="content" class="col-md-12 col-lg-9">
 ...
 $_from = $_smarty_tpl->tpl_vars['notificacionesTodas']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['noti']->index=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['noti']->key => $_smarty_tpl->tpl_vars['noti']->value) {
$_smarty_tpl->tpl_vars['noti']->_loop = true;
 $_smarty_tpl->tpl_vars['noti']->index++;
 $_smarty_tpl->tpl_vars['noti']->first = $_smarty_tpl->tpl_vars['noti']->index === 0;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['foo']['first'] = $_smarty_tpl->tpl_vars['noti']->first;
?>
        	            <div class="tr <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['foo']['first']) {?> first <?php }?> pst">
        	                <div class="td uppercase w-100"><strong><?php echo $_smarty_tpl->tpl_vars['noti']->value->titulo;?>
:</strong> <?php echo $_smarty_tpl->tpl_vars['noti']->value->descripcion;?>
 <br>
        		                <span class="small txt-primary"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo smarty_modifier_relative_date(smarty_modifier_date_format($_smarty_tpl->tpl_vars['noti']->value->fecha,'Y-m-d H:i:s'));?>
</span>
        	                </div>
        	            </div>
                <?php } ?>
