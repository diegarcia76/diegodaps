<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-22 15:31:25
         compiled from "/var/www/daps/site/application/views/admin/productos/form_marcas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14776567185a7b1a8ba0aa79-06226728%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f85d816f29e3c544aa5d1b9256f6a09f17031783' => 
    array (
      0 => '/var/www/daps/site/application/views/admin/productos/form_marcas.tpl',
      1 => 1519324283,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14776567185a7b1a8ba0aa79-06226728',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a7b1a8baa3181_43002709',
  'variables' => 
  array (
    'pageTitle' => 0,
    'pageSubtitle' => 0,
...
<?php if ($_valid && !is_callable('content_5a7b1a8baa3181_43002709')) {function content_5a7b1a8baa3181_43002709($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
admin/productos/save_marca" id="frmSaveMarcas" method="post">
                	<input type="hidden" name="marca_id" value="<?php echo $_smarty_tpl->tpl_vars['editUser']->value->id;?>
" />
					<div class="form-body">						
...
" required="required">
 ...
 $_from = $_smarty_tpl->tpl_vars['editUser']->value->submarcas; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['sub']->key => $_smarty_tpl->tpl_vars['sub']->value) {
$_smarty_tpl->tpl_vars['sub']->_loop = true;
?>
			                        <tr>
			                        	<td><i class="icon-fullscreen"></i><input type="hidden" class="submarca_id" name="submarca_id[]" value="<?php echo $_smarty_tpl->tpl_vars['sub']->value->id;?>
" /></td>
			                        	<td><input type="text" id="premio-titulo-<?php echo $_smarty_tpl->tpl_vars['sub']->value->id;?>
" name="nombreS[]" value="<?php echo $_smarty_tpl->tpl_vars['sub']->value->nombre;?>
" required="required" class="required form-control nombreS" /></td>
			                        	<td><input type="text" id="premio-description-<?php echo $_smarty_tpl->tpl_vars['sub']->value->id;?>
" name="descripcionS[]" value="<?php echo $_smarty_tpl->tpl_vars['sub']->value->descripcion;?>
" class="form-control descripcionS" /></td>
...
admin/productos/listar_marcas" class="btn default pull-right">Cancelar</a>
						</div>
					</div>
				</form>
				<!-- END FORM-->
...
<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo site_url();?>
assets/admin/js/marcas.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
