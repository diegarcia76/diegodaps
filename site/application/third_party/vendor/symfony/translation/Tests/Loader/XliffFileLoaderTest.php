...
class XliffFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEncoding()
    {
        ...
        $this->assertEquals(utf8_decode('fÃ¶Ã¶'), $catalogue->get('bar', 'domain1'));
        $this->assertEquals(utf8_decode('bÃ¤r'), $catalogue->get('foo', 'domain1'));
        $this->assertEquals(array('notes' => array(array('content' => utf8_decode('bÃ¤z')))), $catalogue->getMetadata('foo', 'domain1'));
    }
