...
* [User Guide][docs-guide] â€“ For both getting started and in-depth SDK usage information
* [API Docs][docs-api] â€“ For details about operations, parameters, and responses
* [Blog][sdk-blog] â€“ Tips & tricks, articles, and announcements
* [Sample Project][sdk-sample] - A quick, sample project to help get you started
* [Forum][sdk-forum] â€“ Ask questions, get help, and give feedback
* [Issues][sdk-issues] â€“ Report issues, submit pull requests, and get involved
  (see [Apache 2.0 License][sdk-license])
* [@awsforphp][sdk-twitter] â€“ Follow us on Twitter
...
1. **Sign up for AWS** â€“ Before you begin, you need to
...
* [Guzzle Version 6][guzzle-docs] â€“ PHP HTTP client and framework
