...
class MY_Parser extends CI_Parser {
    ...
    public function __construct()
    {
        ...
        $this->CI->load->library('smartyci','','smarty');
    ...
    */
     ...
     * @return string
     */
    public function parse($template, $data = array(), $return = FALSE, $caching = false, $theme = '')
    {
    ...
    */
    ...
    protected function _update_theme_paths()
    {
        ...
        $this->_template_locations = array(
            ...
            $this->CI->config->item('smarty.theme_path') . 'default/views/modules/' . $this->_module .'/layouts/',
            $this->CI->config->item('smarty.theme_path') . 'default/views/modules/' . $this->_module .'/',
            $this->CI->config->item('smarty.theme_path') . 'default/views/layouts/',
            $this->CI->config->item('smarty.theme_path') . 'default/',
