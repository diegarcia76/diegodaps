...
class Deudores extends BaseAdmin_Controller
{
     ...
     */
    private $parsePath = 'admin/deudores/';

    public function __construct()
    {
        parent::__construct();
        $this->data['menuactive'] = 'deudores';
    ...
    public function index()
    {
       ...
       //$this->data['pagosPendientes'] =  \Managers\PagoManager::getInstance()->getPendientes();
         $this->data['pagosPendientes'] =  \Managers\PagoManager::getInstance()->getPendientesByFecha();
