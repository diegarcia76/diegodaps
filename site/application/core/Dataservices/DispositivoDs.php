...
/**
 * Description of DispositivoDs
 *
 * @author 
 */
class DispositivoDs extends BaseDataService {
    ...
    protected function __construct() {
        parent::__construct();
        $this->tbl_name = "models\Dispositivo";
    ...
    public function getByPlayer($player){
		$todos = $this->em->getRepository($this->tbl_name)->findOneBy(array('playerId' => $player));
		return $todos;
	} 
